...
import UserRegisterAPI from '../../common/Api/UserRegisterAPI'

const SignUp: React.FC = () => {
  let initialCrediantials = {
    name: "",
    email: "",
    password: "",
    confirm_password: "",
  }
  const [credentials, setcredentials] = useState(initialCrediantials);
  ...
  const handleSubmit = async (event: { preventDefault: () => void; }) => {
    ...
    try {
      ...
      if (response.status === 200) {
        ...
        setcredentials(initialCrediantials)
      }
    } catch (error) {
      if (error.response) {
